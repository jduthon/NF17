...
<form class="form-horizontal" method="post" action="" role="form">	
	...
	<div class="form-group">
		<label for="est loué" class="col-sm-1 control-label">Est louée</label>
		<div class="col-sm-5">
	...
	<div class="form-group">
		<span class="col-sm-1 control-label">Date de mise en circulation</span>
			<div class="row">
				...
				<div class="col-sm-1 col-md-1">
					<input type="number" class="form-control" name="annee_mise_en_circulation" id="annee_mise_en_circulation" min="1920" max="2100" step="1">
				</div>
			</div>
	</div>
